...
#   geom_line(data = DF, aes(x = 1:length(DF$meta), y = meta), colour = "red") +
  ...
  theme_minimal() +
  labs(x = "Length (cm)", y = "Assimilated Weight (g), Metabolism (g)", title = paste0("Assimilated Weight and metabolism in ", scenario)) + 
...
ggsave(paste0("figures/assim_v_meta/effectAsymptote/2xEps.png"), plot = plt, width = 18, height = 20, unit = "cm")
