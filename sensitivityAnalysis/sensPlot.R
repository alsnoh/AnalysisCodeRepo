...
ratio <- read.csv("../ForageFishModelRepo/Results/ECG_FoF_ratios_MinMax.csv")
FoFtrends <- read.csv("../ForageFishModelRepo/Results/FoF_trend_MinMax.csv")
ShetTrends <- read.csv("../ForageFishModelRepo/Results/Shetland_trend_MinMax.csv")
